...
<p align="justify">
Based on the confusion matrix generated by the prediction of the neural network, there are a total of 6,054 correctly classified defaults and non-defaults. More importantly, there are 930 defaulters that were incorrectly classified as non-defaulters.  
</p>
<p align="justify">
...
```
<p align="justify">
Based on the results of the 4 different models using the evaluation metrics selected, it is observed that the neural network model produced the best results as compared to the other models.
</p>
